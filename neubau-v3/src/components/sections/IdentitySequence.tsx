                                ...
                                >
                                    <div className="absolute inset-0">
                                        ...
                                        <div className="absolute w-[calc(100%+100px)] h-[130vh] -top-[15vh] -left-[50px]">
                                            ...
                                            >
                                                {/* Kein Portraetfoto vorhanden — thematisches Motion-Panel
                                                    mit dem Motto statt eines fremden Gesichts. */}
                                                <div className="relative flex h-full w-full items-center justify-center overflow-hidden bg-gradient-to-br from-zinc-900 via-zinc-800 to-black dark:from-black dark:via-zinc-950 dark:to-zinc-900">
                                                    <div className="absolute inset-0 bg-[radial-gradient(circle,_#ffffff14_1px,_transparent_1px)] [background-size:24px_24px]" />
                                                    <span className="relative px-8 text-center text-[clamp(2.5rem,9vw,8rem)] font-black leading-[0.85] tracking-tighter text-white/90">
                                                        Leon
                                                        <br />
                                                        Pösken
                                                    </span>
