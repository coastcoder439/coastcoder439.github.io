                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 border-t border-zinc-100 dark:border-zinc-900 pt-8 md:pt-12">
                        ...
                        <div className="md:col-span-7 flex flex-col sm:flex-row gap-8 text-[13px]">
                            <div className="flex-1 space-y-3">
                                <span className="text-zinc-800 dark:text-zinc-200 font-bold uppercase tracking-widest block border-b border-zinc-100 dark:border-zinc-900 pb-3">Regel</span>
...
// v3: Kennzahlen-Strecke gekürzt (Owner: „einkürzen, nicht rausnehmen") — nur noch
// das „Alles geprüft"-Panel, kein Identitäts-Panel, keine Seitwärtsfahrt; 220vh statt 600vh.
...
export default function AboutSection() {const containerRef = useRef<HTMLElement>(null);
    const { scrollYProgress } = useScroll({
        target: containerRef,
        ...
        >
            ...
            <div className="relative pointer-events-none mt-[20vh] md:mt-[20vh]">
                ...
                <div className="bg-background dark:bg-black transition-colors duration-500 pointer-events-auto relative">
                    ...
                    {/* v3 — Block 2: Ablauf (Würfel) + Aufzieher „Muster erkennen, Systeme bauen." */}
                    <AblaufSection />
                    <AuditFunnel />
                    {/* Block 3: alle Projekte in einer Slideshow, danach „Alles geprüft" (gekürzte Strecke) */}
                    <ProjekteSection />
                    <ScrollHijackSection />
                </div>
            </div>
