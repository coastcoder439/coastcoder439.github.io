      ...
      <Document
        ...
        loading={
          <div className="flex flex-col items-center justify-center w-full h-full">
            ...
            <p className="mt-4 text-muted-foreground text-sm font-medium">Dokument wird geladen …</p>
          </div>
        }
      >
            ...
            {Array.from(new Array(numPages || 0), (el, index) => (
              ...
              >
                ...
                <div className="flex flex-row justify-center">
                  <span className="text-xs font-semibold text-muted-foreground">Seite {index + 1}</span>
                </div>
              </div>
            ))}
          </SidebarContent>
            ...
            <div className="flex p-3 border-b border-border bg-background/50 backdrop-blur-md justify-between items-center z-10 shrink-0">
              <div className="flex flex-row gap-3 items-center">
                ...
                <div className="text-sm font-medium text-foreground bg-muted px-3 py-1.5 rounded-md">
                  {numPages ? `Seite ${currentPage} von ${numPages}` : "Wird geladen …"}
                </div>
              </div>
              <div className="flex flex-row gap-2 items-center">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button variant="ghost" size="icon" className="size-8 rounded-full hover:bg-muted" aria-label="Dokument durchsuchen">
                ...
                <Button asChild variant="ghost" size="icon" className="size-8 rounded-full hover:bg-muted">
                  <a href={url} download aria-label="Lebenslauf herunterladen">
