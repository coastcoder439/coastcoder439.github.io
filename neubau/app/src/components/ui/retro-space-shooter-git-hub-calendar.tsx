...
export const GithubCalendar = memo(function GithubCalendar({
  ...
  useEffect(() => {
    ...
    fetchContributions(username)
      ...
      .catch(() => setFetchError('GitHub-Beiträge konnten nicht geladen werden.'))
    ...
    >
      <div className="w-fit mx-auto max-w-full flex flex-col gap-3 p-3">
          ...
          {tooltip.visible &&
            (() => {
              ...
              const tooltipText = tooltip.label
                ? `${tooltip.label} am ${formattedDate}.`
                : count === 0
                  ? `Keine Beiträge am ${formattedDate}.`
                  : `${count} Beitrag${count !== 1 ? "e" : ""} am ${formattedDate}.`;
        ...
        <div className="flex items-center justify-between gap-x-4">
          ...
          <span className="text-[11px] text-muted-foreground select-none">Spielmodus</span>
                <button
