...
export default function Testimonial1() {
  ...
  const stats: StatItem[] = [
    ...
    {
      value: projects.filter((project) => Boolean(project.image)).length,
      decimals: 0,
      suffix: "",
      label: "Mit Repo-Vorschau",
      href: "/projects",
      cta: "Oberflächen ansehen",
    },
    {
      value: projects.filter((project) => Boolean(project.repoUrl)).length,
      decimals: 0,
      suffix: "",
      label: "Repositories",
      href: "/projects",
    ...
    {
      value: portfolioData.techStack.length,
      decimals: 0,
      suffix: "",
      label: "Kerntechnologien",
      href: "/skills",
      cta: "Kompetenzen ansehen",
    },
  ];
    ...
    <div className="bg-white dark:bg-black min-h-screen w-full grid place-content-center py-16 px-4 md:px-8 lg:px-16 relative">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center max-w-5xl mx-auto relative text-neutral-900 dark:text-white px-4 space-y-1 md:space-y-2">
          {[
            { text: "Vom Vertrieb zum Systembauer.", color: "#6366f1", delay: 0 },
            { text: "KI, die konkrete Arbeit übernimmt.", color: "#10b981", delay: 0.15 },
            { text: "Software, im Repository belegt.", color: "#f59e0b", delay: 0.3 },
            { text: "Acht Produkte. Kein Mockup.", color: "#ef4444", delay: 0.45 }
          ].map((line, i) => (
