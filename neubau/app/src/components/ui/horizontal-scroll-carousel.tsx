...
import {
  Users, MessageSquare, Puzzle, Target,
  BookOpen, Network, Search
} from "lucide-react";

// Lucide icons disesuaikan dengan skill baru (AI & Software Engineer)
const skillIcons: Record<string, any> = {
  'Systemdenken': Network,
  'Eigenverantwortung': Target,
  'Pragmatismus': Puzzle,
  'Kommunikation': MessageSquare,
  'Qualitätsfokus': Search,
  'Lernfähigkeit': BookOpen,
  'Nutzerfokus': Users,
};

// Popsy SVG illustrations yang dipastikan berfungsi
const skillVisuals: Record<string, string> = {
  'Systemdenken': '/projects/keel-harness/dashboard.png',
  'Eigenverantwortung': '/projects/oasis/wetter-layer-abnahme.jpeg',
  'Pragmatismus': '/projects/flowvoice/wave.png',
  'Kommunikation': '/projects/keel-showcase/dashboard.png',
  'Qualitätsfokus': '/projects/ebike/zentrale-heute.png',
  'Lernfähigkeit': '/projects/oasis/uebersicht-banner.jpeg',
  'Nutzerfokus': '/projects/ebike/praesentation-kopf.png',
};
...
const allCards = portfolioData.softSkills.slice(0, 10).map((skill, index) => ({
  ...
  url: skillVisuals[skill.name] || '/projects/keel-harness/dashboard.png',
        ...
        <div className="w-full px-6 md:px-24 pt-6 md:pt-8 lg:pt-12 z-20 flex-shrink-0">
          ...
          >
            ...
            <p className="text-muted-foreground text-base md:text-lg lg:text-xl font-medium max-w-2xl leading-relaxed">
              Sieben Prinzipien für klare Entscheidungen, belastbare Systeme und Produkte mit echtem Nutzwert.
            </p>
          </motion.div>
        </div>
