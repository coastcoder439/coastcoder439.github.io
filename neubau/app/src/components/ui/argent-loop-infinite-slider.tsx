...
const PROJECT_DATA: ProjectData[] = [
  {
    ...
    category: "Simulation",
    year: "2026",
    description: "Interaktive Klima-, Wetter- und Kartensimulation.",
  ...
  },
  {
    ...
    year: "2026",
    description: "Website-, Social- und Commerce-Module als Live-Suite.",
    slug: "keel-showcase"
  },
  {
    title: "Keel-Harness",
    ...
    category: "KI-Systeme",
    year: "2026",
    description: "Lokales Agenten-Harness mit echtem Dashboard.",
    slug: "keel-harness"
  },
  {
    ...
    category: "Fullstack",
    year: "2026",
    description: "Buchungsstrecke und operative Zentrale.",
    slug: "ebike-vermietung"
  },
  {
    title: "Shopify-Shop",
    image: "/projects/commerce/preview-viewport.jpeg",
    category: "Commerce-Vorschau",
    year: "2026",
    description: "Echte Produktoberfläche mit transparent synthetischen Kennzahlen.",
  ...
  return (
    <div ref={containerRef} className="relative h-[500vh]">
      ...
      <div className="argent-slider-wrapper">
                      ...
                      return (
                        <div key={i} className="minimap-item-info" style={{ top: `${i * 250}px` }}>
                          ...
                          <div className="minimap-item-info-row">
                            ...
                            >
                              <span className="border-b border-black/10 group-hover/link:border-black pb-1">Mehr ansehen</span>
                            </Link>
                          </div>
                        </div>
                      );
            ...
            <div className="h-[200px] w-full flex items-center justify-center pt-10">
              ...
              >
                <div className="flex items-center gap-4 pointer-events-auto">
                  <MagneticEffect>
                    <a 
                      href="https://github.com/coastcoder439" 
                      target="_blank" 
        ...
        >
                    <span className="text-foreground/40 font-mono text-[10px] tracking-[0.5em] uppercase">Seite</span>
