...
const pages = [
    {
        ...
        rightContent: {
            heading: 'KI-Systeme',
            description: 'Kontrollierte Agenten-Abläufe, lokale Sprachverarbeitung und Automatisierung werden zu nachvollziehbaren Werkzeugen mit sichtbaren Ergebnissen.',
            skills: ["Agenten-Harness", "Whisper", "Transkription", "Audit-Schritte", "PowerShell", "Automatisierung"],
    ...
    },
    {
        ...
        leftContent: {
            heading: 'Fullstack-Produkte',
            description: 'Vom Datenfluss bis zur responsiven Oberfläche entstehen nutzbare Produkte mit TypeScript, React, Next.js, Node.js und Python.',
            skills: ["Systemarchitektur", "Fullstack", "TypeScript", "Next.js", "API-Integration", "Produktdesign"],
    ...
    },
    {
        ...
        leftContent: null,
        rightContent: {
            heading: 'Systemisches Arbeiten',
            description: 'Komplexe Anforderungen werden durch Systemdenken, Eigenverantwortung und klare Kommunikation in kleine, belastbare Produktstände übersetzt.',
            skills: ["Systemdenken", "Eigenverantwortung", "Pragmatismus", "Kommunikation", "Qualitätsfokus", "Nutzerfokus"],
            hoverColor: "bg-purple-600/10"
        },
    },
    {
        isBridge: true,
        heading: 'Echte Produkte und Lösungen, die aus Ideen nutzbare Systeme machen',
        subheading: 'WEITERSCROLLEN',
    }
];
