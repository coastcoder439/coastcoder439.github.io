...
import { ChevronDown, Trophy, Navigation, Briefcase, Rocket, BookOpen, ImageIcon, FileText } from 'lucide-react';
                        ...
                        <div className={cn(
                            ...
                            <div className="flex-1 p-5 flex flex-col gap-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <MegaBoxBig href="/projects" icon={Rocket} title="Projekte" desc="Acht echte Produkte entdecken" theme={theme} pathname={pathname} />
                                    <MegaBoxBig href="/experience" icon={Briefcase} title="Erfahrung" desc="Vom Vertrieb zum Systembauer" theme={theme} pathname={pathname} />
                                </div>
                                {/* Bottom 3 small boxes */}
                                <div className="grid grid-cols-3 gap-4">
                                    <MegaBoxSmall href="/skills" icon={Navigation} title="Kompetenzen" desc="Technik und Arbeitsweise" theme={theme} pathname={pathname} />
                                    <MegaBoxSmall href="/achievements" icon={Trophy} title="Meilensteine" desc="Belegte Produktstände" theme={theme} pathname={pathname} />
                                    <MegaBoxSmall href="/blog" icon={BookOpen} title="Notizen" desc="Technische Entscheidungen" theme={theme} pathname={pathname} />
                                </div>
                            </div>
                            ...
                            <div className={cn(
                                ...
                                <SidebarLink href="/gallery" icon={ImageIcon} title="Galerie" desc="Echte Produktansichten" theme={theme} pathname={pathname} />
                                <SidebarLink href="/resume" icon={FileText} title="Lebenslauf" desc="Ansehen oder herunterladen" theme={theme} pathname={pathname} />
                            </div>
                        </div>
                    </motion.div>
                )}
