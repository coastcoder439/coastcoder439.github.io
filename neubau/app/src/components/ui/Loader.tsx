...
import {
  Network, Cpu, Database, Fingerprint, Zap,
...
const config = {
  ai: [
    { icon: Cpu, label: "KI", color: "#ef4444" },
    { icon: Network, label: "AGENT", color: "#3b82f6" },
    { icon: Cpu, label: "KEEL", color: "#eab308" },
    { icon: Database, label: "DATEN", color: "#22c55e" },
    { icon: Fingerprint, label: "AUDIT", color: "#a855f7" },
    { icon: Zap, label: "TOOLS", color: "#f97316" }
  ],
  software: [
    ...
    { icon: Shield, label: "SICHER", color: "#8b5cf6" },
    { icon: Workflow, label: "CI/CD", color: "#06b6d4" }
  ],
  softskill: [
    { icon: Lightbulb, label: "IDEE", color: "#eab308" },
    { icon: Users, label: "TEAM", color: "#3b82f6" },
    { icon: MessageSquare, label: "DIALOG", color: "#22c55e" },
    { icon: Target, label: "ZIEL", color: "#ef4444" },
    { icon: Compass, label: "SYSTEM", color: "#a855f7" },
    { icon: Briefcase, label: "FÜHRUNG", color: "#f97316" }
  ],
  default: [
    { icon: Zap, label: "Start", color: "#00d2ff" },
    { icon: Zap, label: "Aktion", color: "#ff00ff" },
    { icon: Zap, label: "Fokus", color: "#ffef00" },
    { icon: Zap, label: "Warten", color: "#ffffff" },
    { icon: Zap, label: "Fertig", color: "#ff5252" },
    { icon: Zap, label: "Lädt", color: "#00e676" }
  ]
};
