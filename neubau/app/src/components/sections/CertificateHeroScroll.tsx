...
const PROJECT_POOL: ImageItem[] = [
    { id: "oasis-weather", src: "/projects/oasis/wetter-layer-abnahme.jpeg", alt: "Oasis Simulator mit Wetter-Layer", isPdf: false },
    { id: "oasis-overview", src: "/projects/oasis/uebersicht-banner.jpeg", alt: "Oasis Simulator Übersicht", isPdf: false },
    { id: "keel-showcase", src: "/projects/keel-showcase/dashboard.png", alt: "Keel Showcase Dashboard", isPdf: false },
    { id: "keel-harness", src: "/projects/keel-harness/dashboard.png", alt: "Keel-Harness Dashboard", isPdf: false },
    { id: "flowvoice", src: "/projects/flowvoice/wave.png", alt: "FlowVoice Audiowelle", isPdf: false },
    { id: "ebike-booking", src: "/projects/ebike/praesentation-kopf.png", alt: "WL Bike Rental Buchungsstrecke", isPdf: false },
    { id: "ebike-control", src: "/projects/ebike/zentrale-heute.png", alt: "WL Bike Rental Zentrale", isPdf: false },
    { id: "commerce", src: "/projects/commerce/keel-commerce.png", alt: "Keel Commerce Vorschau", isPdf: false }
];
...
const CertificateHeroScroll: FC<CertificateHeroScrollProps> = ({ isLowPowerMode: isLowPowerModeProp }) => {
    ...
    // Select project screenshots on mount to avoid a hydration mismatch.
    const [randomCertificates, setRandomCertificates] = useState<ImageItem[]>([]);

    useEffect(() => {
        const shuffled = [...PROJECT_POOL].sort(() => 0.5 - Math.random());
            ...
            <div ref={fixedContainerRef} className="fixed inset-0 z-10 h-screen w-full overflow-hidden bg-transparent pointer-events-none">
                ...
                >
                    ...
                    <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed mb-10 animate-fade-in-up delay-200">
                        Eine visuelle Reise durch veröffentlichte Systeme und echte Oberflächen.
                    </p>
                    <button
