...
import { Github, Linkedin, ArrowDownRight, Bot, Zap, ExternalLink, FolderKanban } from 'lucide-react';
      ...
      <main className="relative flex-1 flex flex-col justify-center pt-40 pb-20 z-10 max-w-[105rem] w-full mx-auto">
        <div className="flex relative gap-4 px-6 md:items-center w-full flex-col justify-center">
          ...
          <AnimatePresence>
            {tooltip.show && (
              ...
              >
                ...
                {tooltip.icon === 'bot' && <FolderKanban className="w-4 h-4" />}
          ...
          <div className="md:flex gap-8 items-center relative">
            ...
            >
              Hi, ich bin {personal.name}. Ich baue Systeme, die wirklich genutzt werden.
            </motion.p>
            ...
            <div className="relative">
              ...
              >
                ...
                <div
                  ...
                  onClick={() => window.open('https://keel-showcase.vercel.app', '_blank')}
                  onMouseEnter={(e) => setTooltip({ show: true, text: "Keel Showcase öffnen", icon: 'zap', x: e.clientX, y: e.clientY })}
          ...
          <div className="md:flex gap-8 items-center relative">
            ...
            >
              ...
              <div
                ...
                onClick={() => { window.location.href = '/projects/keel-harness'; }}
                onMouseEnter={(e) => setTooltip({ show: true, text: "Keel-Harness ansehen", icon: 'bot', x: e.clientX, y: e.clientY })}
                onMouseMove={(e) => setTooltip(prev => ({ ...prev, x: e.clientX, y: e.clientY }))}
                onMouseLeave={() => setTooltip(prev => ({ ...prev, show: false }))}
              >
            ...
            >
              KI-Systeme, Automatisierung, Webentwicklung. Vom Repository bis zum nutzbaren Produkt.
            </motion.p>
          </div>
        </div>
