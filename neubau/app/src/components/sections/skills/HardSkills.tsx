              ...
              <div className="shrink-0 mt-auto pt-4">
                ...
                >
                  {expanded.ai ? (
                        ...
                        <>Mehr anzeigen ({categorizedSkills['ai'].length - 3}) <ChevronDown className="w-4 h-4" /></>
                  )}
                </button>
              </div>
            )}
              ...
              <div className="shrink-0 mt-auto pt-4">
                ...
                >
                  {expanded.software ? (
                        ...
                        <>Mehr anzeigen ({categorizedSkills['software'].length - 3}) <ChevronDown className="w-4 h-4" /></>
                  )}
                </button>
              </div>
            )}
              ...
              <div className="shrink-0 mt-auto pt-4">
                ...
                >
                  {expanded.additional ? (
                        ...
                        <>Mehr anzeigen ({categorizedSkills['additional'].length - 3}) <ChevronDown className="w-4 h-4" /></>
                  )}
                </button>
              </div>
            )}
