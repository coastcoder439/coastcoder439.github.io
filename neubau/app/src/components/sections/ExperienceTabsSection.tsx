        ...
        <div className="py-16 space-y-12">
            ...
            >
                ...
                <p className="text-center text-muted-foreground mt-2 max-w-md mx-auto">
                    {activeTab === 'education' && 'Fundament für Vertrieb, Immobilien und systematisches Arbeiten'}
                    {activeTab === 'journey' && 'Stationen, Verantwortung und Entwicklung im Überblick'}
                    {activeTab === 'experience' && 'Berufserfahrung mit konkreten Aufgaben und Ergebnissen'}
                </p>
            </motion.div>
