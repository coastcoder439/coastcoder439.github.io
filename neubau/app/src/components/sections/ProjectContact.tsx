        ...
        <section className="relative z-10 w-full bg-transparent px-6 md:px-12 py-20 md:py-32 overflow-hidden">
            ...
            <div className="max-w-[1536px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-20">
                <div className="relative z-10 w-full lg:w-1/2">
                    <BlockInTextCard
                        tag="/ Auf ein Gespräch"
                        isLowPowerMode={isLowPowerMode}
                        text={
                            <>
                                <strong><Hover3DFlipText text="Lass uns etwas Belastbares bauen." /></strong> <Hover3DFlipText text="Von KI-Systemen bis zu skalierbaren Webprodukten: Gemeinsam wird aus einer Idee ein nutzbarer Produktstand." />
                            </>
                        }
                        examples={[
                            "Du suchst Fullstack- und KI-Kompetenz?",
                            "Du willst einen Prozess sinnvoll automatisieren?",
                            "Du möchtest eine Produktidee besprechen?",
                        ]}
                    />
                </div>
