...
export default function CleanFilmGrid({ isLowPowerMode }: { isLowPowerMode?: boolean }) {
    ...
    const [galleryItems] = useState(() => portfolioData.gallery.map((item) => ({
        ...item,
                ...
                <div className="flex-1 min-w-0 space-y-16">
                    ...
                    {categories.length === 0 && (
                        <div className="py-20 text-center">
                            <p className="text-muted-foreground font-mono">Keine passenden Inhalte gefunden.</p>
                        </div>
                    )}
                </div>
                        ...
                        <div className="absolute top-0 left-0 w-full p-6 flex justify-between items-center z-[110]" onClick={(e) => e.stopPropagation()}>
                            ...
                            <div className="flex items-center gap-4">
                                <button
                                    ...
                                    title={isLightboxMaximized ? "Verkleinern" : "Vergrößern"}
                                >
                                    {isLightboxMaximized ? (
