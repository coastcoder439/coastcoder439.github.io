...
export default function StatsSection({ scrollYProgress, showOnly }: { scrollYProgress?: any, showOnly?: 'top' | 'bottom' }) {
    ...
    useEffect(() => {
        const galleryImages = [
            { src: '/projects/oasis/wetter-layer-abnahme.jpeg', alt: 'Oasis Wetterlayer' },
            { src: '/projects/oasis/uebersicht-banner.jpeg', alt: 'Oasis Übersicht' },
            { src: '/projects/keel-showcase/dashboard.png', alt: 'Keel Showcase Dashboard' },
            { src: '/projects/keel-harness/dashboard.png', alt: 'Keel-Harness Dashboard' },
            { src: '/projects/flowvoice/wave.png', alt: 'FlowVoice Wellenansicht' },
            { src: '/projects/ebike/praesentation-kopf.png', alt: 'E-Bike Buchungsstrecke' },
            { src: '/projects/ebike/zentrale-heute.png', alt: 'E-Bike Zentrale' },
            { src: '/projects/commerce/preview-viewport.jpeg', alt: 'Commerce Vorschau' },
            { src: '/projects/commerce/preview-fullpage.jpeg', alt: 'Commerce Gesamtansicht' },
        ];
            ...
            {(showOnly === 'top' || !showOnly) && (
                <>
                    <div className="max-w-6xl mx-auto px-6 w-full pt-32 pb-16 text-center space-y-4">
                        ...
                        >
                            Echte Oberflächen, technische Entscheidungen und kurze Notizen zu den gezeigten Produkten.
                        </motion.p>
                    </div>
                    ...
                    <div className="flex items-center justify-between border-b border-border/50 pb-8">
                        <div className="space-y-1">
                            <h3 className="text-2xl font-bold text-foreground flex items-center gap-3">
                                Aktuelle Produktnotizen
                            </h3>
                            <p className="text-muted-foreground/60 font-medium uppercase tracking-widest text-xs">SYSTEME • OBERFLÄCHEN • TECHNISCHE EINBLICKE</p>
                        </div>
