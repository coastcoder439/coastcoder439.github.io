...
export default function HomePage() {
    ...
    // ANSICHTS-FIX: Der arc-preloader-Provider (ArcPreloaderWrapper) sass im alten
    // Layout und fehlt hier, daher bliebe `phase` auf "intro" und der Hero unsichtbar.
    // Nach Ende des LoadingScreen (isLoading=false) wird der Inhalt daher immer enthuellt.
